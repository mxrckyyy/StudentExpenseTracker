...
namespace StudentExpenseTracker.Migrations
{
    ...
    [Migration("20260912131655_AddCategoryAndBudgetModels")]
    partial class AddCategoryAndBudgetModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentExpenseTracker.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StudentExpenseTracker.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudentExpenseTracker.Models.Budget", b =>
                {
                    ...
                    b.HasOne("StudentExpenseTracker.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
